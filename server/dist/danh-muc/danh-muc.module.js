...
const danh_muc_provider_1 = require("./danh-muc.provider");
...
exports.DanhMucModule = DanhMucModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [danh_muc_service_1.DanhMucService, ...danh_muc_provider_1.danhMucProviders],
        exports: [danh_muc_service_1.DanhMucService],
    })
], DanhMucModule);
